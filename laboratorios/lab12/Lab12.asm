...
MaskPB0           EQU $01
MaskPB1           EQU $08
;Mascaras para Banderas_1
ShortP0           EQU $01
LongP0            EQU $02
ShortP1           EQU $04
LongP1            EQU $08
;Mascaras para Banderas_2
ArrayOK           EQU $10
RS                EQU $01
LCD_OK            EQU $02
FinSendLCD        EQU $04
...
Teclas            dB $01
                  ...
                  dB $0E
                                ...
                                Org $1120
T_Write_RTC       dB $01,$03,$10,$05,$28,$11,$25

                                  Org $1200
MSG1:             FCC "Microprocesadores "
                  dB EOB
MSG2:             FCC " DS1307 con IIC "
                  dB EOB
...
;===============================================================================
        ...
        Movw #Tarea_RTC_Est1,Est_Pres_RTC
...
Tarea_RTC_Est1
                Brset Banderas_1,LongP0,Escribir
                Movb #tTimerRead_RTC,TimerRead_RTC
                Movw #Tarea_RTC_Est3,Est_Pres_RTC
                Bra FinTarea_RTCEst1
                
Escribir        Movb #$07,Index_RTC
                Bset IBCR,MS_SL
                Bset IBCR,TX_RX
                Movb #Dir_WR,IBDR
                Movw #Tarea_RTC_Est2,Est_Pres_RTC

FinTarea_RTCEst1  Rts

;============================== RTC ESTADO 2 ==================================

Tarea_RTC_Est2
                Brclr IBSR,IBIF,FinTarea_RTCEst2
                Bset IBSR,IBIF
                Jsr Write_RTC
                
                Brset Banderas_1,LongP0,FinTarea_RTCEst2
                Movw #Tarea_RTC_Est1,Est_Pres_RTC

FinTarea_RTCEst2    Rts

;============================== RTC ESTADO 3 ==================================

Tarea_RTC_Est3
                Tst TimerRead_RTC
                Bne FinTarea_RTCEst3
                
                Movb #$07,Index_RTC
                Bset IBCR,MS_SL
                Bset IBCR,TX_RX
                Movb #Dir_WR,IBDR
                Movw #Tarea_RTC_Est4,Est_Pres_RTC

FinTarea_RTCEst3  Rts

;============================== RTC ESTADO 4 ==================================

Tarea_RTC_Est4
                Brclr IBSR,IBIF,FinTarea_RTCEst4
                Bset IBSR,IBIF
                Jsr Read_RTC

                Ldaa Index_RTC
                Cmpa #$07
                Bne FinTarea_RTCEst4
                Ldx #T_Read_RTC
                Ldaa 0,X
                Staa BCD1
                Ldaa 1,X
...
ContinuarWrite  Ldx #T_Write_RTC
                Ldaa Index_RTC
                Movb A,X,IBDR
...
ContinuarWrite2 Bclr IBCR,MS_SL
                Bclr Banderas_1,LongP0
