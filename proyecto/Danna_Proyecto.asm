...
Tarea_Resumen
        ; Verificar si ya estamos en modo Resumen
        Brset Funcion,$80,FinTarea_Resumen
...
Resumen_Sin_Vueltas:
        ; Mostrar 00 en ambos displays
        Movb #$00,BCD1              ; BCD para "00"
        Movb #$00,BCD2              ; BCD para "00"

Resumen_Actualizar:
        ; Actualizar displays
        Jsr BCD_7SEG

        ; Establecer modo Resumen en Función
        Movb #$FF,Funcion
